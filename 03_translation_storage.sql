...
-- https://www.onetcenter.org/dictionary/24.0/mysql/content_model_reference.html
...
CREATE TABLE `content_model_reference_nb` (
	...
	`changed` date NOT NULL DEFAULT '2015-09-05' COMMENT 'dato siste endring', 
...
-- https://www.onetcenter.org/dictionary/24.0/mysql/dwa_reference.html
...
CREATE TABLE `dwa_reference_nb` (
	...
	`changed` date NOT NULL DEFAULT '2017-05-26', 
	PRIMARY KEY (`dwa_id`),
	KEY `iwa_id` (`iwa_id`),
...
-- https://www.onetcenter.org/dictionary/24.0/mysql/iwa_reference.html
...
-- https://www.onetcenter.org/dictionary/24.0/mysql/occupation_data.html
